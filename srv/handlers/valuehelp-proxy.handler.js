...
module.exports = {
  ...
  readMaterialPlant: expose('VH_MaterialPlant'),
  ...
  readCustomerGroup1: expose('VH_CustomerGroup1'),
  readCustomerGroup2: expose('VH_CustomerGroup2'),
  readCustomerGroup3: expose('VH_CustomerGroup3'),
  readCustomerGroup4: expose('VH_CustomerGroup4'),
  readCustomerGroup5: expose('VH_CustomerGroup5'),
  readCustomerGroup6: expose('VH_CustomerGroup6'),
  readCustomerGroup7: expose('VH_CustomerGroup7'),
  readCustomerGroup8: expose('VH_CustomerGroup8'),
  readCustomerGroup9: expose('VH_CustomerGroup9'),
  readCustomerGroup10: expose('VH_CustomerGroup10'),
  readCustomerAttribute1: expose('VH_CustomerAttribute1'),
  readCustomerAttribute2: expose('VH_CustomerAttribute2'),
  readCustomerAttribute3: expose('VH_CustomerAttribute3'),
  readCustomerAttribute4: expose('VH_CustomerAttribute4'),
  readCustomerAttribute5: expose('VH_CustomerAttribute5'),
  readCustomerAttribute6: expose('VH_CustomerAttribute6'),
  readCustomerAttribute7: expose('VH_CustomerAttribute7'),
  readCustomerAttribute8: expose('VH_CustomerAttribute8'),
  readCustomerAttribute9: expose('VH_CustomerAttribute9'),
  readCustomerAttribute10: expose('VH_CustomerAttribute10'),
  readDestMercRelevanciaAnalco: expose('VH_DestMercRelevanciaAnalco'),
  readDestMercRelevanciaCerveza: expose('VH_DestMercRelevanciaCerveza'),
  readDestMercRelevanciaCPCH: expose('VH_DestMercRelevanciaCPCH'),
  readDestMercRelevanciaVSPT: expose('VH_DestMercRelevanciaVSPT'),
  readDestMercPotencialAnalco: expose('VH_DestMercPotencialAnalco'),
  readDestMercPotencialCerveza: expose('VH_DestMercPotencialCerveza'),
  readDestMercPotencialCPCH: expose('VH_DestMercPotencialCPCH'),
  readDestMercPotencialVSPT: expose('VH_DestMercPotencialVSPT'),
  readDestMercClienteAdyacente: expose('VH_DestMercClienteAdyacente'),
  readDestMercFormatoPrecio: expose('VH_DestMercFormatoPrecio'),
  readDestMercGestionEmbalaje: expose('VH_DestMercGestionEmbalaje'),
  readDestMercGestionEnvase: expose('VH_DestMercGestionEnvase'),
  readDestMercNorma4540: expose('VH_DestMercNorma4540'),
  readDestMercActivoSGA: expose('VH_DestMercActivoSGA'),
  readDestMercCampoAdic11: expose('VH_DestMercCampoAdic11'),
  readDestMercCampoAdic12: expose('VH_DestMercCampoAdic12'),
  readDestMercCampoAdic13: expose('VH_DestMercCampoAdic13'),
  readDestMercCampoAdic14: expose('VH_DestMercCampoAdic14'),
  readDestMercCampoAdic15: expose('VH_DestMercCampoAdic15'),
  readDestMercCampoAdic16: expose('VH_DestMercCampoAdic16'),
  readDestMercCampoAdic17: expose('VH_DestMercCampoAdic17'),
  readDestMercCampoAdic18: expose('VH_DestMercCampoAdic18'),
