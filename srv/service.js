...
module.exports = cds.service.impl(async function () {
  ...
  this.on('READ', 'VH_DestMercRelevanciaVSPT', vh.readDestMercRelevanciaVSPT);
  this.on('READ', 'VH_DestMercPotencialAnalco', vh.readDestMercPotencialAnalco);
  this.on('READ', 'VH_DestMercPotencialCerveza', vh.readDestMercPotencialCerveza);
  this.on('READ', 'VH_DestMercPotencialCPCH', vh.readDestMercPotencialCPCH);
  this.on('READ', 'VH_DestMercPotencialVSPT', vh.readDestMercPotencialVSPT);
  this.on('READ', 'VH_DestMercClienteAdyacente', vh.readDestMercClienteAdyacente);
  this.on('READ', 'VH_DestMercFormatoPrecio', vh.readDestMercFormatoPrecio);
  this.on('READ', 'VH_DestMercGestionEmbalaje', vh.readDestMercGestionEmbalaje);
  this.on('READ', 'VH_DestMercGestionEnvase', vh.readDestMercGestionEnvase);
  this.on('READ', 'VH_DestMercNorma4540', vh.readDestMercNorma4540);
  this.on('READ', 'VH_DestMercActivoSGA', vh.readDestMercActivoSGA);
  this.on('READ', 'VH_DestMercCampoAdic11', vh.readDestMercCampoAdic11);
  this.on('READ', 'VH_DestMercCampoAdic12', vh.readDestMercCampoAdic12);
  this.on('READ', 'VH_DestMercCampoAdic13', vh.readDestMercCampoAdic13);
  this.on('READ', 'VH_DestMercCampoAdic14', vh.readDestMercCampoAdic14);
  this.on('READ', 'VH_DestMercCampoAdic15', vh.readDestMercCampoAdic15);
  this.on('READ', 'VH_DestMercCampoAdic16', vh.readDestMercCampoAdic16);
  this.on('READ', 'VH_DestMercCampoAdic17', vh.readDestMercCampoAdic17);
  this.on('READ', 'VH_DestMercCampoAdic18', vh.readDestMercCampoAdic18);
